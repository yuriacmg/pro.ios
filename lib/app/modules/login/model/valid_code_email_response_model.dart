...
class ValidCodeEmailResponseModel {
  Value? value;
  bool? hasSucceeded;

  ValidCodeEmailResponseModel({this.value, this.hasSucceeded});

  ValidCodeEmailResponseModel.fromJson(Map<String, dynamic> json) {
...
class Value {
  ...
  Value({this.iRegistroId, this.bValidacion, this.vCodigoValidacion});
