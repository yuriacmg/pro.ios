...
class _ExamResultPageState extends State<ExamResultPage> {
  ...
  Future<void> initData() async {
    ...
    //areUserHistory
    final areUserHistoryBox =
        await Hive.openBox<AreaUserHistoryEntity>('areaUserHistoryBox');
    final listAreaUserHistory = areUserHistoryBox.values.toList();

    final indexAreaUserHistory = listAreaUserHistory.indexWhere((element) =>
        element.areaId == widget.area.codigo &&
        element.userDocument == userFound.numdoc &&
        element.areaCode == widget.area.codigoPreparate &&
        element.generalCode == widget.generalCode,);

    if (indexAreaUserHistory != -1) {
      widget.areaUserHistory.areaIntentos =
          (widget.areaUserHistory.areaIntentos ?? 0) + 1;
      await areUserHistoryBox.putAt(
          indexAreaUserHistory, widget.areaUserHistory,);
    }
    ...
    widget.history.attempsNumber =
        widget.areaUserHistory.areaIntentos; //++histories
      ...
      child: Stack(
        children: [
          ResultEvaluationWidget(
              imageKey: imageKey,
              total: widget.history.totalCorrect!.toString(),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: GenericStylesApp().messageJustifyPage(
                                  text:
                                      'Estos son los resultados de tu simulacro de ${widget.area.nombre}.',
                                ),
                              ),
                              Row(
                                children: [
                                    ...
                                    iconText(
                                      ...
                                      final alert = RepeatPrepareExamAlert(
                                        ...
                                        onTap: () async {
                                          ...
                                          final prepareAreaCommonbox =
                                              await Hive.openBox<
                                                      PrepareAreaCommonEntity>(
                                                  'prepareAreaCommonBox',);
                                          final listArea = prepareAreaCommonbox
                                              .values
                                              .toList();

                                          final indexArea = listArea.indexWhere(
                                              (element) =>
                                                  element.codigo ==
                                                      widget.area.codigo &&
                                                  element.codigoPreparate ==
                                                      widget.area
                                                          .codigoPreparate,);
                                          widget.area.status =
                                              ConstantsApp.areaProcess;
                                          await prepareAreaCommonbox.putAt(
                                              indexArea, widget.area,);
                              ...
                              GenericCardWidget(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Divider(color: Colors.transparent),
                                    titleSubtitle('Área', widget.area.nombre!),
                              ...
                              //      const Divider(color: Colors.transparent),
                              //      titleSubtitle('Puntaje general', widget.history.totalCorrect!.toStringAsPrecision(2)),
                              //    ],
                              //  ),
                              //),
                              GenericCardWidget(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    title('Resultado de la evaluación'),
                                    subtitlePage(
                                        'El siguiente gráfico muestra tu desempeño en el área de ${widget.area.nombre}',),
                                    const Divider(color: Colors.transparent),
                                    Center(
                                      child: SizedBox(
                                        height: 200,
                                            ...
                                            PieChart(
                                              PieChartData(
                                                ...
                                                sections: showingSections(
                                                  widget.history.totalCorrect!,
                                                  widget.history.totalError!,
                                                  widget
                                                      .history.totalUnanswered!,
                                                ),
                                              ),
                                            ),
                                            Container(
