...
part of 'beca_otro_pais_hijo_entity.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class BecaOtroPaisHijoEntityAdapter
    extends TypeAdapter<BecaOtroPaisHijoEntity> {
  @override
  final int typeId = 41;

  @override
  BecaOtroPaisHijoEntity read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return BecaOtroPaisHijoEntity(
      ...
      dFechaPostulacion: fields[13] as String?,
        ...
        (fields[14] as List?)?.cast<BecasOtrosPaisesHijos>();
  }

  @override
  void write(BinaryWriter writer, BecaOtroPaisHijoEntity obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.iBopId)
  ...
  bool operator ==(Object other) =>
      ...
      other is BecaOtroPaisHijoEntityAdapter &&
