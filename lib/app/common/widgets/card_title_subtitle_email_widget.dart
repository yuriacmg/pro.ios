...
class CardTitleSubtitleEmailWidget extends StatefulWidget {
  CardTitleSubtitleEmailWidget({
    required this.title,
  ...
  @override
  State<CardTitleSubtitleEmailWidget> createState() => _CardTitleSubtitleEmailWidgetState();
}

class _CardTitleSubtitleEmailWidgetState extends State<CardTitleSubtitleEmailWidget> {
