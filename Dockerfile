...
#====================================
LABEL vendor="PRONABEC"
LABEL team="DEVOPS Team - OTI"
LABEL maintainer="walter.munguia@pronabec.gob.pe"
ARG ENV=dev
#====================================
...
RUN flutter clean
RUN flutter pub get
RUN flutter build web --release --target lib/main_${ENV}.dart
